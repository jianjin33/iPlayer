...
public class ExplosionAnimator extends ValueAnimator {
    ...
    private static final float X = UIUtils.dp2px(5);
    private static final float Y = UIUtils.dp2px(20);
    private static final float V = UIUtils.dp2px(2);
    private static final float W = UIUtils.dp2px(1);
